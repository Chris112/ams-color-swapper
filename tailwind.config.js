  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-spectrum': 'linear-gradient(180deg, #FF006E, #FF8C00, #FFD600, #00DC82, #0096FF, #8338EC)',
        'gradient-midnight': 'linear-gradient(to bottom, #0F172A, #1E293B, #312E81)',
        'gradient-radial-pink': 'radial-gradient(circle at center, rgba(255, 0, 110, 0.3), transparent 70%)',
        'gradient-radial-blue': 'radial-gradient(circle at center, rgba(0, 150, 255, 0.3), transparent 70%)',
      },
      boxShadow: {
